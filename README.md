...
Face-Level Editing: Go beyond global colors. Select and paint individual faces of any 3D object to create complex patterns.

Snap-to-Grid: Use the integrated magnet system for pixel-perfect alignment.
...
Python Integration: Use the included plugintemplate.py to build your own tools that interact with the 3D canvas in real-time.

Siri-Style UI: Visual cues let you know when the app is "listening" for external commands.

Getting Started
Download the Blueprinter-Setup.exe from the latest release.

Install to any path.

Launch and start building on the infinite blueprint.

Export your work or use the Gallery to keep track of your thumbnails.
